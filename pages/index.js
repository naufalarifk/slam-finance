      ...
      <section className="lg:px-24 px-12">
        ...
        <div className="my-10 h-[114px] flex flex-row justify-between mx-auto bg-[#02AF91]">
          <div className="mx-auto my-auto w-1/2">
            ...
            <p className="text-white text-center font-semibold text-xs lg:text-2xl">20% occures 30% fees</p>
          </div>
          ...
          <div className="mx-auto my-auto w-1/2">
            ...
            <p className="text-white text-center font-semibold text-xs lg:text-2xl">65% occures 70% fees</p>
          </div>
        </div>
        ...
        <div className="flex lg:flex-row flex-col lg:space-x-6 space-y-3 mt-10">
        {
          data.map((item, index) => {
            return (
              <div key={index} className='bg-white bg-opacity-10 flex flex-row items-center w-full lg:w-1/3 justify-center py-6 border border-white rounded-lg space-x-5'>
